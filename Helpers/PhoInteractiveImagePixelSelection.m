...
[new_iips_Config, new_iips_State, new_iips_SelectionOutput] = InteractiveImagePixelSelection();
...
function [iips_Config, iips_State, iips_SelectionOutput] = InteractiveImagePixelSelection(desiredSelectionName)
